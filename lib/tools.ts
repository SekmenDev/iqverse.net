...
export const tools: Tool[] = [
  // AI & Agents
  { name: "AI Agents Scanner", desc: "Scan any website for AI agent readiness. Inspect robots.txt, sitemaps, MCP configuration, OpenAPI specs, and metadata for AI crawler optimization.", icon: "/agentscan/logoX4.png", url: "/agentscan/", type: "open", tags: "robots sitemap mcp oauth security ai agent", cat: "AI & Agents" },
  ...
  // Browser Tools
  { name: "QR Forge", desc: "Generate custom QR codes instantly from URLs, plain text, Wi-Fi credentials, and vCards with SVG or PNG export directly in your browser.", icon: "/qrforge/logoX4.png", url: "/qrforge/", type: "open", tags: "qr code svg png generate wifi vcard", cat: "Browser Tools" },
  { name: "Link Radar", desc: "Scan web pages to detect broken links, 404 errors, and redirect loops instantly in your browser with no server processing required.", icon: "/linkradar/logoX4.png", url: "/linkradar/", type: "open", tags: "links 404 redirect scan broken crawl", cat: "Browser Tools" },
  { name: "Favicon Generator", desc: "Convert any image into browser favicons, Apple touch icons, and web manifest.json files in all required sizes locally.", icon: "/favicongen/logoX4.png", url: "/favicongen/", type: "open", tags: "favicon icon manifest apple touch 16 32 180", cat: "Browser Tools" },
  { name: "JSON Formatter", desc: "Format, validate, minify, and sort JSON data online. Fast, browser-native JSON beautifier and linter with zero server tracking.", icon: "/json/logoX4.png", url: "/json/", type: "open", tags: "json format validate minify lint sort", cat: "Browser Tools" },
  { name: "Base64 & URL Encoder", desc: "Encode and decode Base64 strings, URL parameters, JWT tokens, and Data URIs instantly with client-side privacy.", icon: "/encodelab/logoX4.png", url: "/encodelab/", type: "open", tags: "base64 url encode decode jwt data uri", cat: "Browser Tools" },
  ...
  { name: "RegEx Forge", desc: "Build, test, and debug regular expressions online with real-time string matching, group syntax highlighting, and pattern explanations.", icon: "/regex/logoX4.png", url: "/regex/", type: "open", tags: "regex regexp pattern match test explain", cat: "Browser Tools" },
  ...
  { name: "Diff Checker", desc: "Compare text, JSON, and code snippets side-by-side with live line-by-line diff highlighting and inline comparison.", icon: "/diff-checker/logoX4.png", url: "/diff-checker/", type: "open", tags: "diff compare text json code side-by-side highlight", cat: "Browser Tools" },
  ...
  // Security
  { name: "Password Generator", desc: "Generate cryptographically secure passwords, API keys, and secret tokens locally with entropy evaluation and zero network calls.", icon: "/password/logoX4.png", url: "/password/", type: "open", tags: "password secret random secure generate entropy", cat: "Security" },
  { name: "HeaderScan", desc: "Analyze HTTP response headers for any web URL. Inspect security policies, cache directives, server configurations, and CSP.", icon: "/headers/logoX4.png", url: "/headers/", type: "open", tags: "http headers security inspect network response", cat: "Security" },
  ...
  // Design
  { name: "Color Palette Generator", desc: "Generate color palettes, extract dominant colors from images, and export HEX, RGB, and HSL color values.", icon: "/chromata/logoX4.png", url: "/chromata/", type: "open", tags: "color palette css design hex rgb hsl", cat: "Design" },
  ...
  // Network
  { name: "DNS Lookup", desc: "Perform online DNS queries for A, AAAA, MX, TXT, NS, CNAME, SOA, and SRV records using DNS-over-HTTPS.", icon: "/dnslookup/logoX4.png", url: "/dnslookup/", type: "open", tags: "dns domain mx txt a aaaa cname ns lookup", cat: "Network" },
  ...
  // SaaS
  { name: "GOO: School Platform", desc: "GOO is a modular school management platform for student records, attendance tracking, grade reporting, timetables, and parent communication.", icon: "/goo/logoX4.png", url: "/goo/", type: "saas", tags: "school education attendance grades timetable", cat: "SaaS" },
  { name: "GES: Quiz Platform", desc: "GES is an interactive quiz platform to create online assessments, deliver tests, and track student performance in real time.", icon: "/ges/logoX4.png", url: "/ges/", type: "saas", tags: "quiz assessment education analytics reports", cat: "SaaS" },
  { name: "GYP: License Tracker", desc: "GYP is a software license and client management platform for tracking client subscriptions, license keys, billing, and support requests.", icon: "/gyp/logoX4.png", url: "/gyp/", type: "saas", tags: "license crm billing clients software management", cat: "SaaS" },
  { name: "GST: Stock Tracker", desc: "GST is a mobile-first inventory and expense tracking web app designed for small workshops, business stock, and materials management.", icon: "/gst/logoX4.png", url: "/gst/", type: "saas", tags: "inventory stock expense mobile pwa shop", cat: "SaaS" },
];
