...
export const tools: Tool[] = [
  ...
  // Data & Formats
  { name: "JSON Formatter", desc: "Format, validate, minify and sort JSON data online. Fast, browser-native JSON beautifier and linter with zero server tracking.", icon: "{ }", url: "/json/", type: "open", tags: "json format validate minify lint sort", cats: ["Data & Formats"], aliases: "beautify pretty print prettify unminify parse" },
  { name: "YAML / JSON / TOML Converter", desc: "Convert configuration files seamlessly between YAML, JSON and TOML formats with syntax validation in your browser.", icon: "🔄", url: "/yaml-json-toml/", type: "open", tags: "yaml json toml convert format parser config", cats: ["Data & Formats"], aliases: "yml config translate serialize kubernetes manifest" },
  { name: "CSV Viewer & Converter", desc: "Inspect and parse CSV files in an interactive data table. Convert CSV to JSON, Markdown or SQL insert statements effortlessly.", icon: "📊", url: "/csvviewer/", type: "open", tags: "csv json sql table data convert format", cats: ["Data & Formats"], aliases: "spreadsheet excel tsv delimited table viewer" },
  { name: "Data Converter", desc: "Convert between JSON, CSV, Hex and Base64 data formats locally. Fast client-side data transformer with zero file uploads.", icon: "🔁", url: "/dataconverter/", type: "open", tags: "json csv hex base64 convert format", cats: ["Data & Formats"], aliases: "transform translate serialize deserialize" },
  { name: "JSON to TypeScript", desc: "Convert JSON into TypeScript interfaces or type aliases. Merges shapes across array elements, marks missing fields optional and reuses identical shapes.", icon: "🧬", url: "/json-to-typescript/", type: "open", tags: "json typescript interface type generator schema convert", cats: ["Data & Formats", "Text & Code"], aliases: "json to ts quicktype interface generator typegen api types dto" },
  { name: "SQL Formatter & Minifier", desc: "Format and minify SQL for PostgreSQL, MySQL, SQL Server, Oracle, BigQuery, Snowflake and more, with a per-statement summary.", icon: "🗄️", url: "/sql-formatter/", type: "open", tags: "sql format beautify minify postgres mysql query pretty print dialect", cats: ["Data & Formats", "Text & Code"], aliases: "sql beautifier pretty print query formatter tsql plsql bigquery" },
  { name: "Number Base Converter", desc: "Convert between binary, octal, decimal, hex and base 36 with arbitrary precision. Inspect 8 to 64-bit two's complement views and flip individual bits.", icon: "🔢", url: "/base-converter/", type: "open", tags: "binary octal decimal hex base convert bits twos complement radix", cats: ["Data & Formats"], aliases: "hex to decimal binary converter radix bitwise bit flip two's complement" },
  { name: "Timestamp Converter", desc: "Convert Unix epoch timestamps to ISO 8601, UTC and local date formats instantly with multi-timezone support.", icon: "🕒", url: "/timestamp-converter/", type: "open", tags: "timestamp unix epoch iso8601 date time timezone convert", cats: ["Data & Formats"], aliases: "epoch unixtime milliseconds utc datetime tz" },
  { name: "Compression", desc: "Compress and decompress text strings using browser-native Deflate and Gzip algorithms with Base64 output.", icon: "🗜️", url: "/compression/", type: "open", tags: "compress decompress deflate base64 text", cats: ["Data & Formats", "Text & Code"], aliases: "gzip zlib inflate zip shrink" },

  // Text & Code
  { name: "RegEx Forge", desc: "Build, test and debug regular expressions online with real-time string matching, group syntax highlighting and pattern explanations.", icon: "∑", url: "/regex/", type: "open", tags: "regex regexp pattern match test explain", cats: ["Text & Code"], aliases: "regular expression capture group lookahead tester" },
  { name: "Diff Checker", desc: "Compare text, JSON and code snippets side-by-side with live line-by-line diff highlighting and inline comparison.", icon: "🔀", url: "/diff-checker/", type: "open", tags: "diff compare text json code side-by-side highlight", cats: ["Text & Code"], aliases: "compare files patch changes delta merge" },
  { name: "Markdown Previewer", desc: "Write and preview Markdown with real-time HTML rendering, syntax highlighting, GitHub Flavored Markdown support and file export.", icon: "📝", url: "/markdown-preview/", type: "open", tags: "markdown md html preview render export editor", cats: ["Text & Code"], aliases: "gfm readme md to html editor renderer" },
  { name: "Text Case Converter", desc: "Convert text between camelCase, snake_case, kebab-case, PascalCase, Title Case and UPPERCASE string formats instantly.", icon: "🔤", url: "/case-converter/", type: "open", tags: "case convert camelcase snakecase kebabcase titlecase string", cats: ["Text & Code"], aliases: "uppercase lowercase slugify constant case naming" },
  ...
  { name: "Favicon Generator", desc: "Convert any image into browser favicons, Apple touch icons and web manifest.json files in all required sizes locally.", icon: "🏷️", url: "/favicongen/", type: "open", tags: "favicon icon manifest apple touch 16 32 180", cats: ["Generators", "Design"], aliases: "site icon ico pwa manifest touch icon", featured: true },
  ...
  { name: "Cron Expression Builder", desc: "Build and test cron expressions visually. Translate cron syntax into plain English descriptions and view upcoming execution schedules.", icon: "⏰", url: "/cron-builder/", type: "open", tags: "cron expression schedule time generator parser", cats: ["Generators"], aliases: "crontab scheduler job quartz recurring task" },

  // APIs & HTTP
  { name: "URL Tools", desc: "Parse, inspect, encode, decode and build web URLs. Manage query string parameters visually right inside your browser.", icon: "🌐", url: "/url/", type: "open", tags: "url parse build encode decode query string", cats: ["APIs & HTTP", "Web & SEO"], aliases: "querystring uri link builder params" },
  { name: "HTTP Status Code Reference", desc: "Searchable guide for HTTP status codes (1xx-5xx), headers and API response rules with practical developer examples.", icon: "📗", url: "/http-status/", type: "open", tags: "http status code 200 404 500 reference header rest", cats: ["APIs & HTTP"], aliases: "301 302 403 418 502 response codes cheatsheet" },
  { name: "CORS Tester", desc: "Test cross-origin resource sharing (CORS) headers origins and preflight OPTIONS responses for API endpoints.", icon: "📡", url: "/cors-tester/", type: "open", tags: "cors options origin headers api test preflight", cats: ["APIs & HTTP", "Security"], aliases: "cross origin access-control-allow-origin preflight blocked" },
  { name: "curl to fetch Converter", desc: "Paste a curl command and get equivalent JavaScript fetch or Python requests code, with headers, JSON and form bodies, basic auth and redirect flags.", icon: "🔀", url: "/curl-converter/", type: "open", tags: "curl fetch python requests convert http api command", cats: ["APIs & HTTP", "Text & Code"], aliases: "curl to javascript curl to python http client convert import postman" },
  { name: "Webhook Inspector", desc: "Test, inspect and debug incoming HTTP webhook payloads, headers and request bodies in real time directly in your browser.", icon: "🪝", url: "/webhook-inspector/", type: "open", tags: "webhook payload inspect echo request debug http", cats: ["APIs & HTTP"], aliases: "requestbin webhook.site callback receiver payload debug" },
  { name: "Cookie Inspector", desc: "Parse HTTP Cookie and Set-Cookie headers for SameSite, Secure, HttpOnly and Max-Age flags, or view the cookies your browser exposes on this site.", icon: "🍪", url: "/cookie-inspector/", type: "open", tags: "cookie parse inspect samesite secure httpOnly session browser view", cats: ["APIs & HTTP", "Security"], aliases: "set-cookie samesite none partitioned session storage view browser cookies document.cookie" },

  // Security
  { name: "Browser Fingerprint & Privacy Inspector", desc: "See your browser fingerprint and every signal a website can read from your browser, ranked by how much each one identifies you. Canvas, WebGL, fonts, audio and hardware measured locally, plus opt-in IP, VPN, Tor and private browsing detection.", icon: "🧬", url: "/browser-fingerprint/", type: "open", tags: "fingerprint privacy ip vpn tor incognito canvas webgl webgpu audio fonts entropy tracking", cats: ["Security", "Network"], aliases: "am i unique panopticlick device fingerprint tracker canvas fingerprint browser info user agent entropy anti detect what is my ip vpn detection tor check incognito private browsing detection proxy leak headless bot detection spoofing check request headers", featured: true },
  { name: "HeaderScan", desc: "Analyze HTTP response headers for any web URL. Inspect security policies, cache directives, server configurations and CSP.", icon: "▤", url: "/headers/", type: "open", tags: "http headers security inspect network response", cats: ["Security", "APIs & HTTP"], aliases: "hsts csp x-frame-options cache-control securityheaders", featured: true },
  { name: "CSP Header Builder", desc: "Build and validate custom Content Security Policy (CSP) headers to defend web applications against XSS and injection attacks.", icon: "🛡️", url: "/csp-builder/", type: "open", tags: "csp content security policy header builder directives XSS", cats: ["Security", "APIs & HTTP"], aliases: "content-security-policy nonce unsafe-inline script-src xss" },
  ...
  { name: "SPF, DKIM & DMARC Checker", desc: "Parse and validate email authentication DNS records. Counts SPF lookups against the limit of 10, grades DMARC policy strength and estimates DKIM key size.", icon: "📧", url: "/email-auth/", type: "open", tags: "spf dkim dmarc email authentication dns txt record deliverability", cats: ["Security", "Network"], aliases: "email spoofing deliverability mail auth txt record spf lookup limit" },

  // Crypto & Hashing
  { name: "Password Generator", desc: "Generate cryptographically secure passwords, API keys and secret tokens locally with entropy evaluation and zero network calls.", icon: "🔑", url: "/password/", type: "open", tags: "password secret random secure generate entropy", cats: ["Crypto & Hashing", "Generators", "Security"], aliases: "passphrase api key token random string diceware" },
  { name: "Password Strength & Entropy Analyzer", desc: "Score password strength with zxcvbn pattern matching against breached passwords, dictionary words, keyboard runs and dates, entirely offline.", icon: "💪", url: "/password-analyzer/", type: "open", tags: "password strength entropy zxcvbn security crack time", cats: ["Crypto & Hashing"], aliases: "how strong is my password bits brute force estimate" },
  { name: "Hashing", desc: "Calculate cryptographic SHA-256, SHA-512, MD5 and HMAC hashes locally in your browser with hex or Base64 encoding.", icon: "🔒", url: "/hashing/", type: "open", tags: "hash sha hmac digest security crypto", cats: ["Crypto & Hashing"], aliases: "sha256 sha1 md5 checksum digest signature" },
  { name: "File Hash Verifier", desc: "Verify file integrity by calculating MD5, SHA-1, SHA-256 and SHA-512 checksums locally without uploading files.", icon: "✔️", url: "/file-hash/", type: "open", tags: "file hash checksum sha256 sha512 md5 verify integrity", cats: ["Crypto & Hashing"], aliases: "checksum verify download integrity sha256sum iso" },
  { name: "SRI Hash Generator", desc: "Generate Subresource Integrity hashes for CDN scripts and stylesheets, build the ready-to-paste tag and verify an existing integrity attribute.", icon: "🔗", url: "/sri-generator/", type: "open", tags: "sri subresource integrity hash sha384 cdn script crossorigin", cats: ["Crypto & Hashing", "Security"], aliases: "integrity attribute cdn tampering script verification supply chain" },
  { name: "JWT Debugger & Verifier", desc: "Decode, inspect and verify JSON Web Tokens (JWT) headers and payload claims locally using Web Crypto API.", icon: "🔑", url: "/jwt-debugger/", type: "open", tags: "jwt decode verify signature token claim header security", cats: ["Crypto & Hashing", "Security"], aliases: "jsonwebtoken bearer token hs256 rs256 oauth claims" },
  { name: "TOTP Authenticator Generator", desc: "Generate RFC 6238 two-factor codes from a base32 secret or otpauth URI, watch the countdown and produce an enrollment QR code locally.", icon: "🔐", url: "/totp-generator/", type: "open", tags: "totp otp 2fa two factor authenticator rfc6238 hotp base32 mfa", cats: ["Crypto & Hashing", "Security"], aliases: "google authenticator 2fa code mfa one time password otpauth qr enrollment" },
  ...
  // Design
  { name: "Color Palette Generator", desc: "Generate color palettes, extract dominant colors from images and export HEX, RGB and HSL color values.", icon: "🎨", url: "/chromata/", type: "open", tags: "color palette css design hex rgb hsl", cats: ["Design", "Generators"], aliases: "swatch color picker scheme dominant colour extract" },
  { name: "CSS Units Converter", desc: "Convert CSS units between pixels (px), rem, em, viewports (vw/vh) and percentages with live responsive preview.", icon: "📐", url: "/cssunits/", type: "open", tags: "css units rem px em vw convert design", cats: ["Design"], aliases: "px to rem vh vmin ch pt responsive sizing" },
  { name: "SVG Optimizer", desc: "Optimize and minify SVG markup. Strip metadata, clean attributes and compress vector graphic code for web performance.", icon: "✨", url: "/svg-optimizer/", type: "open", tags: "svg optimize minify svgo vector cleanup graphics", cats: ["Design"], aliases: "svgo clean vector shrink path minify icon" },
  { name: "CSS Box Shadow Builder", desc: "Build layered CSS box-shadow values visually. Tune offset, blur, spread, colour and inset per layer with a live preview.", icon: "🌓", url: "/box-shadow/", type: "open", tags: "box shadow css layers blur spread inset design generator", cats: ["Design", "Generators"], aliases: "drop shadow elevation depth material shadow generator neumorphism" },
  { name: "Cubic Bezier Easing Editor", desc: "Drag control points to build CSS cubic-bezier() timing functions. Compare against built-in easings and preview the motion live.", icon: "📉", url: "/cubic-bezier/", type: "open", tags: "cubic bezier easing curve animation timing css transition", cats: ["Design"], aliases: "ease in out timing function motion curve animation editor penner" },
  { name: "CSS Gradient Builder", desc: "Design linear, radial and conic CSS gradients visually. Adjust color stops and export production-ready CSS code.", icon: "🌈", url: "/gradient-builder/", type: "open", tags: "css gradient linear radial conic visual design color", cats: ["Design", "Generators"], aliases: "linear-gradient colour stops mesh background generator" },
  { name: "Image Optimizer", desc: "Compress and optimize PNG, JPEG and WebP images directly in your browser without quality loss or uploading files.", icon: "🖼️", url: "/imageoptimizer/", type: "open", tags: "image compress webp png jpeg optimize performance", cats: ["Design"], aliases: "shrink photo lossless minify picture squoosh" },
  { name: "Image Format Converter", desc: "Convert images between PNG, JPEG, WebP and AVIF formats with resolution scaling and quality controls in your browser.", icon: "🖼️", url: "/image-converter/", type: "open", tags: "image convert webp png jpeg avif canvas resize", cats: ["Design"], aliases: "heic jpg to png resize scale picture transcode" },
  { name: "Icon & Sprite Sheet Generator", desc: "Combine multiple PNG/SVG icons into optimized image sprite sheets with automatically generated CSS classes and JSON maps.", icon: "🧩", url: "/sprite-generator/", type: "open", tags: "sprite sheet icon canvas css mapping export assets", cats: ["Design", "Generators"], aliases: "atlas texture packer icon set css sprites" },
  { name: "WCAG Contrast Checker", desc: "Test web color contrast ratios against WCAG 2.1 AA and AAA accessibility standards for text and UI components.", icon: "🎨", url: "/wcag-contrast/", type: "open", tags: "contrast ratio wcag accessibility color aa aaa compliance", cats: ["Design"], aliases: "a11y accessible colour contrast ratio readable text" },

  // Desktop
  { name: "Volumer", desc: "Control system volume via mouse wheel on the Windows taskbar", icon: "🖱️", url: "https://github.com/sekmenhuseyin/volumer", type: "open", tags: "windows volume taskbar mouse wheel utility tray", cats: ["Desktop"], aliases: "scroll volume windows tray audio control" },
  ...
  { name: "Bruno", desc: "Fast and Git-friendly open-source API client. Desktop client is free & open-source (team sync uses paid tiers).", icon: "🐶", url: "https://github.com/usebruno/bruno", type: "open", tags: "api client postman alternative rest graphql git desktop", cats: ["Desktop", "APIs & HTTP"], aliases: "postman insomnia alternative http client collections" },
  ...
  { name: "GTR: Site Crawler & Monitor", desc: "GTR runs IQVerse's tool checks across every page of your site on a schedule, tracking a health score, history and alerts in one place. Coming soon, join the waitlist.", icon: "🕸️", url: "/gtr/", type: "coming", tags: "crawler monitor site-wide score history alerts waitlist saas", cats: ["SaaS"], aliases: "g-tool runner site wide scan aggregate report aeo health score waitlist", featured: true },
];
