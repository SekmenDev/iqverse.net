...
export const tools: Tool[] = [
  ...
  { name: "Cookie Inspector", desc: "Parse and inspect HTTP Cookie and Set-Cookie response headers for SameSite, Secure, HttpOnly and Max-Age security flags.", icon: "🍪", url: "/cookie-inspector/", type: "open", tags: "cookie parse inspect samesite secure httpOnly session", cats: ["APIs & HTTP", "Security"], aliases: "set-cookie samesite none partitioned session storage" },
