...
export const tools: Tool[] = [
  ...
  { name: "Number Base Converter", desc: "Convert between binary, octal, decimal, hex and base 36 with arbitrary precision. Inspect 8 to 64-bit two's complement views and flip individual bits.", icon: "🔢", url: "/base-converter/", type: "open", tags: "binary octal decimal hex base convert bits twos complement radix", cats: ["Browser Tools"], aliases: "hex to decimal binary converter radix bitwise bit flip two's complement" },
  { name: "SQL Formatter & Minifier", desc: "Format and minify SQL for PostgreSQL, MySQL, SQL Server, Oracle, BigQuery, Snowflake and more, with a per-statement summary.", icon: "🗄️", url: "/sql-formatter/", type: "open", tags: "sql format beautify minify postgres mysql query pretty print dialect", cats: ["Browser Tools"], aliases: "sql beautifier pretty print query formatter tsql plsql bigquery" },
  { name: "JSON to TypeScript", desc: "Convert JSON into TypeScript interfaces or type aliases. Merges shapes across array elements, marks missing fields optional and reuses identical shapes.", icon: "🧬", url: "/json-to-typescript/", type: "open", tags: "json typescript interface type generator schema convert", cats: ["Browser Tools"], aliases: "json to ts quicktype interface generator typegen api types dto" },
