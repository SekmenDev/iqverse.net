...
export const tools: Tool[] = [
  ...
  // Security
  { name: "Browser Fingerprint & Privacy Inspector", desc: "See your browser fingerprint and every signal a website can read from your browser, ranked by how much each one identifies you. Canvas, WebGL, fonts, audio and hardware measured locally, plus opt-in IP, VPN, Tor and private browsing detection.", icon: "🧬", url: "/browser-fingerprint/", type: "open", tags: "fingerprint privacy ip vpn tor incognito canvas webgl audio fonts entropy tracking", cats: ["Security", "Network"], aliases: "am i unique panopticlick device fingerprint tracker canvas fingerprint browser info user agent entropy anti detect what is my ip vpn detection tor check incognito private browsing detection proxy leak", featured: true },
