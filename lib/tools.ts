...
export const tools: Tool[] = [
  ...
  // Security
  { name: "Browser Fingerprint & Privacy Inspector", desc: "See your browser fingerprint and every signal a website can read from your browser, ranked by how much each one identifies you. Canvas, WebGL, fonts, audio, hardware and privacy flags, all measured locally.", icon: "🧬", url: "/browser-fingerprint/", type: "open", tags: "fingerprint privacy canvas webgl audio fonts entropy tracking browser info", cats: ["Security", "Network"], aliases: "am i unique panopticlick device fingerprint tracker canvas fingerprint browser info user agent entropy anti detect", featured: true },
