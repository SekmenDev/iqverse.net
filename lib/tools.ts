...
export const tools: Tool[] = [
  ...
  { name: "HTTP Status Code Reference", desc: "Searchable guide for HTTP status codes (1xx-5xx), headers and API response rules with practical developer examples.", icon: "📗", url: "/http-status/", type: "open", tags: "http status code 200 404 500 reference header rest", cats: ["APIs & HTTP"], aliases: "301 302 403 418 502 response codes cheatsheet", featured: true },
  ...
  { name: "HeaderScan", desc: "Analyze HTTP response headers for any web URL. Inspect security policies, cache directives, server configurations and CSP.", icon: "▤", url: "/headers/", type: "open", tags: "http headers security inspect network response", cats: ["Security", "APIs & HTTP"], aliases: "hsts csp x-frame-options cache-control securityheaders" },
