...
export const tools: Tool[] = [
  ...
  // Browser Tools
  { name: "Web Baseline Checker", desc: "Audit any website against core web standards and baseline hygiene: HTTPS, favicon, title, viewport, H1, header, footer, schema, robots.txt, sitemap.xml, and security headers.", icon: "🛡️", url: "/web-baseline/", type: "open", tags: "baseline audit checklist website seo https favicon robots sitemap schema h1 header footer viewport security web standards", cat: "Browser Tools" },
