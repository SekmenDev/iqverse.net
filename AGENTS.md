...
- Enforce strict typing. No `any` in TypeScript.
...
- Plan before implementing. Get the plan approved before starting.
- Once approved, execute autonomously.
- Propose and get approval before deviating from an approved plan.
- Verify the codebase compiles/builds after changes.
- Write or update tests for every change and run the suite.
- Commit incrementally with short, clear messages.
