...
export const tools: Tool[] = [
  ...
  // Web & SEO
  { name: "Web Baseline Checker", desc: "Audit any website against core web standards and baseline hygiene: HTTPS, favicon, title, viewport, H1, header, footer, schema, robots.txt, sitemap.xml and security headers.", icon: "🛡️", url: "/web-baseline/", type: "open", tags: "baseline audit checklist website seo https favicon robots sitemap schema h1 header footer viewport security web standards", cats: ["Web & SEO", "Security", "AI & Agents"], aliases: "site audit lighthouse seo checkup web vitals hygiene" },
  ...
  { name: "Password Strength & Entropy Analyzer", desc: "Evaluate password security strength, bit entropy score, pattern detection and estimated crack time entirely offline.", icon: "💪", url: "/password-analyzer/", type: "open", tags: "password strength entropy zxcvbn security crack time", cats: ["Crypto & Hashing"], aliases: "how strong is my password bits brute force estimate" },
...
export function groupByPrimaryCategory(): Array<{ category: Category; tools: Tool[] }> {
  return CATEGORIES.map(category => ({
    category,
    tools: tools.filter(t => primaryCategory(t) === category && t.featured !== true),
