...
export const tools: Tool[] = [
  ...
  { name: "Diff Checker", desc: "Side-by-side text, JSON and code diff viewer with live change highlighting", icon: "📑", url: "/diff-checker/", type: "open", tags: "diff compare text json code side-by-side highlight", cat: "Browser Tools" },
  { name: "Markdown Previewer", desc: "Live Markdown to HTML renderer with instant preview and file export", icon: "📝", url: "/markdown-preview/", type: "open", tags: "markdown md html preview render export editor", cat: "Browser Tools" },
  { name: "Lorem Ipsum & Fake Data Generator", desc: "Generate names, addresses, emails and mock JSON data batches locally", icon: "🎲", url: "/fake-data-generator/", type: "open", tags: "lorem ipsum fake mock data generate names json", cat: "Browser Tools" },
  { name: "UUID / ULID Generator", desc: "Batch generate cryptographically secure UUID v4 and sortable ULIDs with one-click copy", icon: "🆔", url: "/uuid-ulid-generator/", type: "open", tags: "uuid ulid guid generate random batch id", cat: "Browser Tools" },
  { name: "Cron Expression Builder", desc: "Visual cron schedule generator with human-readable explanations and next execution times", icon: "⏰", url: "/cron-builder/", type: "open", tags: "cron expression schedule time generator parser", cat: "Browser Tools" },
  { name: "Timestamp Converter", desc: "Convert Unix timestamps to ISO 8601 and human-readable dates with timezone support", icon: "🕒", url: "/timestamp-converter/", type: "open", tags: "timestamp unix epoch iso8601 date time timezone convert", cat: "Browser Tools" },
  { name: "Text Case Converter", desc: "Toggle between camelCase, snake_case, kebab-case, Title Case and UPPERCASE instantly", icon: "🔤", url: "/case-converter/", type: "open", tags: "case convert camelcase snakecase kebabcase titlecase string", cat: "Browser Tools" },
  { name: "YAML / JSON / TOML Converter", desc: "Convert seamlessly between YAML, JSON and TOML formats directly in your browser", icon: "🔄", url: "/yaml-json-toml/", type: "open", tags: "yaml json toml convert format parser config", cat: "Browser Tools" },
  { name: "Sitemap Generator", desc: "Crawl web pages or paths to build XML sitemaps ready for search engine indexing", icon: "🗺️", url: "/sitemap-generator/", type: "open", tags: "sitemap xml crawl seo url generator agent", cat: "Browser Tools" },
  { name: "robots.txt Generator & Validator", desc: "Build and test robots.txt directives for web crawlers and AI search bots", icon: "🤖", url: "/robots-generator/", type: "open", tags: "robots txt generator validator crawler useragent allow disallow", cat: "Browser Tools" },
  { name: "Meta Tag & Open Graph Previewer", desc: "Preview social card appearance across Google, X/Twitter, Facebook and LinkedIn", icon: "👁️", url: "/og-preview/", type: "open", tags: "meta tag og opengraph preview twitter facebook card seo", cat: "Browser Tools" },
  ...
  { name: "SVG Optimizer", desc: "Minify and clean inline SVG markup by stripping redundant metadata and attributes", icon: "✨", url: "/svg-optimizer/", type: "open", tags: "svg optimize minify svgo vector cleanup graphics", cat: "Design" },
